## Code of Conduct for Contributing to Django UserPersona Manager

we’re thrilled that you want to contribute to `dj-userpersona-manager`! to ensure a positive and protective environment for everyone involved, please adhere to the following guidelines.

## Contribution Workflow

1. **Fork and Clone**: Start by forking the `dj-userpersona-manager` repository on Github and cloning it to your local machine:
    ```bash
    git clone https://github.com/lazarus-org/dj-userpersona-manager.git
