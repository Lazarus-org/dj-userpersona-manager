# Contributing to Django UserPersona Manager


We’re excited that you’re interested in contributing to `dj-userpersona-manager`! Whether you’re fixing a bug, adding a feature, or improving the project, your help is appreciated.
...
1. **Fork the Repository:**
   ...
   Begin by forking the `dj-userpersona-manager` repository on GitHub. This creates your own copy where you can make changes.
...
2. **Clone Your Fork:**
   ...
   ```bash
   git clone https://github.com/your-username/dj-userpersona-manager.git
   cd dj-userpersona-manager
   ```
...
For linting, `pylint` is used to enforce style and catch potential errors:
   ...
   ```bash
   poetry run pylint persona_manager
   ```
...
1. **Commit Your Changes:**
   ...
   ```bash
   git commit -am 'feat(models): add new field for UserPersona model'
   ```
2. **Push Your Branch:**
...
3. **Open a Pull Request:**
   ...
   Go to the original `dj-userpersona-manager` repository and open a pull request. Include a detailed description of your changes and link any related issues.
...
1. **Open an Issue:**
   ...
   Head over to the `Issues` section of the `dj-userpersona-manager` repository and click "New Issue".
...
Thank you for your interest in contributing to `dj-userpersona-manager`! We look forward to your contributions.
