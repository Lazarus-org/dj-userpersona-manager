...
from persona_manager.validators.config_validators import (
...
class TestValidateBooleanSetting:
    ...
    def test_invalid_boolean(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E001_SOME_BOOLEAN_SETTING"
...
class TestValidateListFields:
    ...
    def test_invalid_list_type(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E002_SOME_LIST_SETTING"
    ...
    def test_empty_list(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E003_SOME_LIST_SETTING"
    ...
    def test_invalid_element_in_list(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E004_SOME_LIST_SETTING"
...
class TestValidateThrottleRate:
    ...
    def test_invalid_format(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E006"
    ...
    def test_invalid_time_unit(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E008"
    ...
    def test_non_numeric_rate(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E007"
...
class TestValidateOptionalClassSetting:
    ...
    def test_invalid_class_import(self) -> None:
        ...
        with patch(
            ...
            assert len(errors) == 1
            assert errors[0].id == "persona_manager.E010_SOME_CLASS_SETTING"
    ...
    def test_invalid_class_path_type(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "persona_manager.E009_SOME_CLASS_SETTING"
    ...
    def test_invalid_list_args_classes_import(self) -> None:
        ...
        assert len(errors) == 2
        assert errors[0].id == "persona_manager.E012_SOME_CLASS_SETTING"
    ...
    def test_invalid_path_classes_import(self) -> None:
        ...
        with patch(
            ...
            assert len(errors) == 1
            assert errors[0].id == "persona_manager.E013_SOME_CLASS_SETTING"
