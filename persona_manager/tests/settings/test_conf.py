...
from persona_manager.settings.conf import PersonaManagerConfig
...
class TestPersonaManagerConfig:
    """
    Test the exception handling in PersonaMangerAppConfig for optional class imports.
    """
