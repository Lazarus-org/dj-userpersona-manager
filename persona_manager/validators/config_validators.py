    ...
    if not isinstance(value, bool):
        errors.append(
            Error(
                ...
                id=f"persona_manager.E001_{config_name}",
            )
        )
    return errors
    ...
    if not isinstance(fields, list):
        errors.append(
            Error(
                ...
                id=f"persona_manager.E002_{config_name}",
            )
        )
        ...
        errors.append(
            Error(
                ...
                id=f"persona_manager.E003_{config_name}",
            )
        )
    else:
        ...
        if invalid_fields:
            errors.append(
                Error(
                    ...
                    id=f"persona_manager.E004_{config_name}",
                )
            )
    ...
    if not isinstance(setting_value, str):
        errors.append(
            Error(
                ...
                id=f"persona_manager.E009_{setting_name}",
            )
        )
        return errors
    ...
    try:
        ...
        errors.append(
            Error(
                ...
                id=f"persona_manager.E010_{setting_name}",
            )
        )
    ...
    if not isinstance(setting_value, list):
        errors.append(
            Error(
                ...
                id=f"persona_manager.E011_{setting_name}",
            )
        )
        return errors
        ...
        if not isinstance(path, str):
            errors.append(
                Error(
                    ...
                    id=f"persona_manager.E012_{setting_name}",
                )
            )
        else:
            ...
            try:
                ...
                errors.append(
                    Error(
                        ...
                        id=f"persona_manager.E013_{setting_name}",
                    )
                )
    ...
    if not isinstance(path, str) or not path:
        errors.append(
            Error(
                ...
                hint="Ensure the upload path is provided as a non-empty string (e.g., 'persona_images/').",
                id=f"persona_manager.E014_{setting_name}",
            )
        )
