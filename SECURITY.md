...
We actively support the following versions of `dj-userpersona-manager` with security updates:
...
We take security issues seriously. If you find a vulnerability in `dj-userpersona-manager`, please report it confidentially. Here are the steps to report security vulnerabilities:
...
- We will create a fix and apply it to all actively supported versions of `dj-userpersona-manager`.
...
- Keep your `dj-userpersona-manager` package up to date with the latest versions to ensure you benefit from the latest security fixes.
...
We strongly encourage responsible disclosure and will work to fix issues in a timely manner. We appreciate any effort to help make `dj-userpersona-manager` more secure for all users.

Thank you for helping us improve the security of `dj-userpersona-manager`!
